...
namespace GymShop.Infrastructure.Data.PostgresMigrations
{
    ...
    [Migration("20260922211906_AddShippingModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymShop.Domain.Entities.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Coupons", null, t =>
                        {
                            t.HasCheckConstraint("CK_Coupons_Date_Range", "\"StartsAtUtc\" IS NULL OR \"EndsAtUtc\" IS NULL OR \"EndsAtUtc\" > \"StartsAtUtc\"");

                            t.HasCheckConstraint("CK_Coupons_Percentage_Range", "\"Type\" <> 'Percentage' OR \"Value\" <= 100");
            ...
            modelBuilder.Entity("GymShop.Domain.Entities.CouponRedemption", b =>
                {
                    ...
                    b.HasIndex("CouponId", "UserId", "Status");
            ...
            modelBuilder.Entity("GymShop.Domain.Entities.Cart", b =>
                {
                    b.HasOne("GymShop.Domain.Entities.Coupon", "Coupon")
                        .WithMany()
            ...
            modelBuilder.Entity("GymShop.Domain.Entities.CouponRedemption", b =>
                {
                    ...
                    b.HasOne("GymShop.Domain.Entities.Order", "Order")
                        ...
                        .HasForeignKey("GymShop.Domain.Entities.CouponRedemption", "OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
